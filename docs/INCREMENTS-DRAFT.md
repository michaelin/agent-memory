# Agent Memory: Incremental Implementation Roadmap (Draft)
...
- **Agent verification test:** Have a subagent read the writing protocol and write a valid note, verify it passes `lint-note`
